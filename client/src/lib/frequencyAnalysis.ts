...
// Reference of known angelic frequencies and their meanings
export const angelicFrequencies: AngelicFrequency[] = [
  { frequency: 432, description: "Earth Frequency / Healing" },
  { frequency: 528, description: "Transformation / DNA Repair" },
  { frequency: 639, description: "Connection / Relationships" },
  { frequency: 741, description: "Awakening Intuition" },
  { frequency: 963, description: "Spiritual Connection" }
];
